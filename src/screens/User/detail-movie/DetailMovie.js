        ...
        <div className="detail-movie__wrap">
          <div className="detail-movie__background">
            ...
            <div className="detail-movie__rate--small">
              <span className="avgPoint">{detailMovie.danhGia}</span>
          ...
          <div className="detail-movie">
            <div className="row m-0">
              <div className="detail-movie__poster col-3 p-lg-0">
                <img className="img-fluid" src={detailMovie.hinhAnh} alt="" />
                <div className="movie__play">
                  <i
                    onClick={() => setModalShow(true)}
                    className="fa fa-play"
              ...
              <div className="detail-movie__info col-6">
                <div>
                  <p>{detailMovie.ngayKhoiChieu.slice(0, 10)}</p>
                  <p className="tenPhim">
              ...
              >
                <div className="row m-0">
                  ...
                  <div className="col-sm-6">
                    ...
                    <p className="content info-full">{detailMovie.moTa}</p>
                  </div>
                </div>
              </div>
              <div
