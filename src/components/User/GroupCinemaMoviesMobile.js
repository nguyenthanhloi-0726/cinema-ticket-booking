  ...
  const renderGroupCinema = () => {
    return props.listGroupCinema
      .filter(groupCinema =>
        lichChieuOnDay.find(
          lichChieu =>
            lichChieu.thongTinRap.maHeThongRap === groupCinema.maHeThongRap
        )
      )
      .map((item, index) => {
        return (
          ...
          >
            ...
            >
              <div className="group-cinema">
                ...
                <span className="group-cinema-name">{item.tenHeThongRap}</span>
              </div>
            </ExpansionPanelSummary>
      ...
      props.groupCinemaInfo[maHeThongRap].forEach(item => {
        if (
          props.detailMovie.lichChieu
            ...
            .find(lichChieu => lichChieu.thongTinRap.maCumRap === item.maCumRap)
        ) {
